...
![Age Group Comparisons based on the Allegheny County COVID-19 Tableau](./rates-1.svg)
...
![Output of Cases2Beds using historical data until January 21st for Allegheny County Using Public Parameters](./C2B-1.svg)
